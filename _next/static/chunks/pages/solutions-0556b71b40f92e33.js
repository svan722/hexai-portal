    ...
    97082: function (l, e, t) {
      ...
      t(37611),
        (e.default = () => {
          ...
          let w = () => {
              window.open(
                "https://app.uniswap.org/explore/tokens/ethereum/0xtttttttttttttttttttttttttt",
                "_blank"
              );
            },
            p = () => {
          ...
          return (0, r.jsxs)(r.Fragment, {
            children: [
              (0, r.jsx)(o.Z, {
                title:
                  "Explore Hex AI's Solutions: Your Perfect Node Power Partner",
                metaTitle:
                  "Discover Hex AI's Node Rentals, Leases, Purchases & Crypto Exclusives",
                metaDescription:
                  "Discover a world of possibilities with Hex AI! Explore our secure node rental, leasing, and purchase options. Learn about our unique community share pool and token benefits. Find the perfect solution for your crypto goals!",
              }),
              (0, r.jsxs)(i.Z, {
                children: [
                  (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)("div", {
                              className:
                                "container-fluid px-3 px-lg-5 d-flex justify-content-center",
                      ...
                      (0, r.jsxs)("section", {
                        ...
                        children: [
                          (0, r.jsx)("div", {
                            className:
                              "row node_rental_section_1 m-0 p-0  first-sticky-gap",
                            children: (0, r.jsxs)("div", {
                              className:
                                "col-lg-12 text-center position-relative top-bottom-margin",
                              children: [
                                (0, r.jsx)("h2", {
                                  className:
                                    "orbitron-txt h1 sec-description-body-title mobile-text",
                                ...
                                (0, r.jsx)("div", {
                                  className:
                                    "container-styled-list container-styled-list-1 position-absolute",
                                  children: (0, r.jsxs)("ul", {
                                    class:
                                      "bg-black list-group border-color text-start",
                                    children: [
                                      (0, r.jsx)("li", {
                          ...
                          (0, r.jsxs)("div", {
                            className:
                              "margin-top-mobile px-lg-0 px-3 sec-description-body-1 text-center position-relative text-white mb-5 second-sticky-gap",
                            children: [
                              (0, r.jsx)("h2", {
                                className:
                                  "orbitron-txt h1 sec-description-body-title destop-text",
                                children: "Node Rental",
                              }),
                              (0, r.jsx)("p", {
                                className: "h6 metrophobic-txt fs-strong-600",
                                children:
                                  "We Are Industry Leaders in Computing Power.",
                              }),
                              (0, r.jsx)("p", {
                                children:
                                  "Offering you the most: Secure, Reliable, Profitable Rental and Leasing Solutions.",
                              }),
                              (0, r.jsx)("p", {
                                className:
                                  "m-0 h6 metrophobic-txt fs-strong-600",
                              ...
                              (0, r.jsx)("p", {
                                className: "metrophobic-txt",
                                children:
                                  "Hex AI has the most flexible integration of nodes, with a wide range of applications.",
                              }),
                              (0, r.jsx)("p", {
                                className: "metrophobic-txt",
                                children:
                                  "With our Node Power, the possibilities are endless!",
                              })
                            ],
                          }),
                          (0, r.jsx)("div", {
                            className:
                              "row node_rental_section_2 m-0 p-0 sec-description-body-3 third-sticky-gap",
                            children: (0, r.jsxs)("div", {
                              className:
                                "col-lg-12 text-center position-relative buy-hardware-sec padding-100",
                              children: [
                                (0, r.jsx)("h2", {
                                  className:
                                    "orbitron-txt h1 sec-description-body-title mobile-text",
                                ...
                                (0, r.jsx)("div", {
                                  className:
                                    "container-styled-list container-styled-list-2 position-absolute",
                                  children: (0, r.jsxs)("ul", {
                                    class:
                                      "bg-black list-group border-color text-start",
                                    children: [
                          ...
                          (0, r.jsxs)("div", {
                            className:
                              "margin-top-mobile px-lg-0 px-3 sec-description-body-2 sec-description-body-4 text-center  d-flex flex-column justify-content-center align-items-center position-relative text-white mb-5 four-sticky-gap",
                            children: [
                              (0, r.jsx)("h2", {
                                className:
                                  "orbitron-txt h1 sec-description-body-title destop-text",
                              ...
                              (0, r.jsx)("p", {
                                ...
                                className: "metrophobic-txt",
                                children:
                                  "Looking for the perfect mining rig? We've got you covered, whether you're a seasoned crypto pro or just starting your journey, we are the expert partner you’ve been looking for.",
                              }),
                              (0, r.jsx)("p", {
                                style: { maxWidth: "800px" },
                                className: "metrophobic-txt",
                                children:
                                  "From base rigs to get you started, all the way up to customizable projects with support and maintenance, we offer expert full-breadth solutions for your hardware needs.",
                              }),
                              (0, r.jsx)(c(), {
                                href: "/hardware",
                              ...
                              (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsx)("div", {
                                  className:
                                    "row m-0 text-center d-flex justify-content-center align-items-center cursor-pointer",
                                  onClick: () => u(),
                                  children: (0, r.jsxs)("div", {
                                    "data-desc": "Buy Hardware",
                                    class:
                                      "col-lg-8 col-12 after-desc-body py-4 px-lg-5 px-0 h-100 hover-text",
                                    children: [
                                      (0, r.jsx)("h2", {
                                        class: "orbitron-txt",
                                      ...
                                      (0, r.jsx)("p", {
                                        children:
                                          "Choose Hex AI and experience the difference a trusted partner can make. Browse our selection of high-performance hardware today!",
                                      }),
                                    ],
                                  }),
                                }),
                          ...
                          (0, r.jsx)("div", {
                            className:
                              "row node_rental_section_3 m-0 p-0 five-sticky-gap sec-description-body-5",
                            children: (0, r.jsxs)("div", {
                              className:
                                "col-lg-12 text-center position-relative buy-hardware-sec padding-100",
                              children: [
                                ...
                                (0, r.jsx)("div", {
                                  className:
                                    "container-styled-list container-styled-list-3 position-absolute",
                                  children: (0, r.jsxs)("ul", {
                                    class:
                                      "bg-black list-group border-color text-start",
                                    children: [
                          ...
                          (0, r.jsxs)("div", {
                            className:
                              "sec-description-body-6 margin-top-mobile px-lg-0 px-3 sec-description-body-3 text-center  d-flex flex-column justify-content-center align-items-center position-relative text-white mb-5 six-sticky-gap",
                            children: [
                              (0, r.jsx)("h2", {
                                className:
                                  "orbitron-txt h1 sec-description-body-title destop-text",
                              ...
                              (0, r.jsx)("p", {
                                ...
                                children:
                                  "Own a Piece of the Future: Invest in $HEXAI",
                              }),
                              (0, r.jsx)("p", {
                                style: { maxWidth: "800px" },
                                className: "metrophobic-txt",
                                children:
                                  "Looking to take your crypto journey to the next level? Our token is your gateway to our thriving, in-demand ecosystem and exciting rewards.",
                              }),
                              (0, r.jsx)("p", {
                                className:
                                  "m-0 h6 fs-weight-600 metrophobic-txt",
                              ...
                              (0, r.jsx)("p", {
                                ...
                                className: "metrophobic-txt",
                                children:
                                  "AI-Driven Growth: $HEXAI is empowered by Artificial Intelligence and rapidly growing. Earn a Share of our Community Mining Pool Rewards: Over $5,000 has already been distributed to token holders to date.",
                              }),
                              (0, r.jsx)("p", {
                                className: "metrophobic-txt",
                                children:
                                  "Invest in a Growing Ecosystem: Backed by innovation, cutting-edge technology, and an expert team.",
                              }),
                              (0, r.jsx)("p", {
                                className: "metrophobic-txt",
                                children:
                                  "Become a part of the Hex AI community and invest in your crypto future today!",
                              }),
                              (0, r.jsxs)("div", {
                                className: "row",
                                children: [
                              ...
                              (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsx)("div", {
                                  className:
                                    "row m-0 text-center d-flex justify-content-center align-items-center pb-5 cursor-pointer",
                                  onClick: () => b(),
                                  children: (0, r.jsxs)("div", {
                                    "data-desc": "Launch DApp",
                                    class:
                                      "col-lg-8 col-12 after-desc-body py-4 px-lg-5 px-2 h-100 hover-text",
                                    children: [
                                      (0, r.jsx)("h2", {
                                        class: "orbitron-txt",
                                        children: "Community Share Pool",
                                      ...
                                      (0, r.jsx)("p", {
                                        className: "metrophobic-txt",
                                        children:
                                          "Do you have $HEXAI? Take part in the community share pool, invest your tokens and reap the rewards!",
                                      }),
                                    ],
                                  }),
                                }),
                  ...
                  (0, r.jsx)("div", {
                    className:
                      "hand-shake-sec text-left d-flex justify-content-center align-items-center bg-black text-white hand-shake-img-sec pb-5",
                    children: (0, r.jsx)("div", {
                      className: "container-fluid",
                      children: (0, r.jsxs)("div", {
                        className: "row w-100",
                        children: [
                          ...
                          (0, r.jsx)("div", { className: "col-lg-6" }),
                        ],
                      }),
                    }),
                  }),
